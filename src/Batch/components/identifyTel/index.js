...
@model(Model)
@binding
export default class IdentifyTel extends Component {
    ...
    return <div className="batch-op-in-col">
      <Grid fluid={true}>
        <Row className='bulk-op-item'>
          <Col className='batch-lenged' md={6}><label>{i18n('cell-phone-number')} : </label></Col>
          <Col md={18}>
            <span>{this.model.mobileNumber}</span>
        ...
        <Row className='bulk-op-item'>
          <Col className='batch-lenged' md={6}><label>{i18n('message-authentication-code')} : </label></Col>
          <Col md={18}>
